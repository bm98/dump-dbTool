...
namespace d1090dataLib.xp11_navlib
{
  ...
  public class navRec
  {
    ...
    public string lat = "";         //02 Lat
    public string lon = "";         //03 Lon
    public string elevation = "";   //04 NDB,VOR: Elevation in feet above MSL
                                    //   FIX: not used
    ...
    public string AsGeoJson()
    {
      ...
      /*
          { 
            ...
            "geometry": { "type": "Point", "coordinates": [ 8.020019531249998, 47.03643850299412 ] }
          }
       */
      string feature = $"\"type\":\"Feature\"";
      string props = $"\"properties\":{{\"Name\":\"{name}\",\"Ident\":\"{icao_id}\"}}";
